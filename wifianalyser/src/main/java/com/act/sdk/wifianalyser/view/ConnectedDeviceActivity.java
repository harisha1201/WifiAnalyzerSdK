 ...
 **/
public class ConnectedDeviceActivity extends AppCompatActivity implements ActWifiListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            actWifiManager.connectedDeviceJsonRequest(ConnectedDeviceActivity.this);
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.connected_devices));
    ...
    public void connectedDevices(ConnectedDeviceResponse responseObj) {
        ...
        txt_request.setText(WifiConstants.CONNECTED_DEVICES_URL);
