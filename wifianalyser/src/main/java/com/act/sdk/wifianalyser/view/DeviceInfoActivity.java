 ...
 **/
public class DeviceInfoActivity extends AppCompatActivity implements ActWifiListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            actWifiManager.deviceInfoJsonRequest(DeviceInfoActivity.this);
        ...
        txt_request.setText(WifiConstants.DEVICE_INFO_URL);
