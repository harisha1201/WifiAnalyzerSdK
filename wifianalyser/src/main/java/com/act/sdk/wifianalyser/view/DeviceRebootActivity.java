...
public class DeviceRebootActivity extends AppCompatActivity implements ActWifiListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            actWifiManager.deviceRebootJsonRequest(DeviceRebootActivity.this);
