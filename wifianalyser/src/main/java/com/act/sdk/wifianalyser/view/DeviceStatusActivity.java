 ...
 **/
public class DeviceStatusActivity extends AppCompatActivity implements ActWifiListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  actWifiManager.deviceStatus(DeviceStatusActivity.this);
        try {
            actWifiManager.deviceStatusJsonRequest(DeviceStatusActivity.this);
        ...
        txt_request.setText(WifiConstants.DEVICE_STATUS_URL);

        getSupportActionBar().setTitle(getResources().getString(R.string.device_status));
